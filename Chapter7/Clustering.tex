%This tex file is for the methods used to model single cell calcium concentration / spikes.  

%-------------------------------------------------
% Document settings 
%------------------------------------------------
% Handbooks says that standard form for thesis is font 12. Line spacing 1.5. left margin 4cm, all other margin 2.5cm.
\documentclass[12pt]{book} % Default font size is 12pt, it can be changed here
\usepackage{graphicx}
\graphicspath{ {Images/} }
\usepackage{multirow}
\usepackage{subfig}
\usepackage[left = 4.1cm, right = 2.5cm, top=2.5cm, bottom = 2.5cm]{geometry} 
\geometry{a4paper} 
\usepackage{setspace}
\onehalfspacing
...
\usepackage{microtype} % tidys lines/linespacing.

%\usepackage{lineno}
%\linenumbers

%The bit below is for the fancy formatting of the chapters etc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage[version=3]{mhchem} % For Ca2+

\usepackage[toc,page]{appendix} %For appendix

\renewcommand{\thesubfigure}{\Alph{subfigure}} % For the lettering of the subfigures. 
%\captionsetup[subfigure]{labelformat=simple, labelsep=colon}

% Package to write algorithms. 
...
%Plot of the first 8 Haar basis vectors. 
  \begin{figure}[ht!]
   \hrulefill
   \begin{center} 
    \subfloat[$h_1$]{{\includegraphics[width = 0.45\linewidth]{HaarBasis1.pdf} }} \quad
      \subfloat[$h_2$]{{\includegraphics[width = 0.45\linewidth]{HaarBasis2.pdf} }}\\ 
      
         \subfloat[$h_3$]{{\includegraphics[width = 0.45\linewidth]{HaarBasis3.pdf} }} \quad
      \subfloat[$h_4$]{{\includegraphics[width = 0.45\linewidth]{HaarBasis4.pdf} }}\\
       
         \subfloat[$h_5$]{{\includegraphics[width = 0.45\linewidth]{HaarBasis5.pdf} }} \quad
      \subfloat[$h_6$]{{\includegraphics[width = 0.45\linewidth]{HaarBasis6.pdf} }} \\
     
       \subfloat[$h_7$]{{\includegraphics[width =0.45\linewidth]{HaarBasis7.pdf} }} \quad
      \subfloat[$h_8$]{{\includegraphics[width = 0.45\linewidth]{HaarBasis8.pdf} }}
    \end{center}     
...
\end{table} 
  ...
  \subfloat[]{{\includegraphics[scale = 0.32]{HaarExample_3.pdf} }} \quad
   ...
   \hrulefill
   \begin{center} 
    {\includegraphics[width = 0.9\linewidth]{FeatureEx_method.png} }
    \end{center}     
...
To illustrate the method we generate 30 intensity functions on the interval $[0,20]$, shown in Figure \ref{fig:Example} (A). Each function has a base intensity drawn uniformly from $[1,5]$. Functions 1-10 (black lines) have a bump added in the region $[0,10]$. Functions 11-20 (red lines) have a bump added in the region $[10,20]$. And functions 21-30 (blue lines) have a bump added in both regions. The width of the bumps are fixed at 3.1 and 1.9 in the regions $[0,10]$ and $[10,20]$, respectively. The height of each bump is drawn uniformly from $[0.5,5]$. The onset of the bumps in $[0,10]$ occur uniformly in the interval $[1,5.4]$ and the onset on the bumps in $[10,20]$ occur uniformly in $[11,15.4]$. 
 ...
 \begin{figure}[t!]
   \hrulefill
   \begin{center} 
    \subfloat[]{{\includegraphics[width = 0.82\linewidth]{Ex_plot.pdf} }} \\
      \subfloat[]{{\includegraphics[width = 0.82\linewidth]{Ex_features.pdf} }} \\
      \subfloat[]{{\includegraphics[width = 0.82\linewidth]{Ex_sizes.pdf} }}     
    \end{center}     
...
%Plot of the clusters on position and magnitude.
  \begin{figure}[ht!]
   \hrulefill
   \begin{center} 
    \subfloat[ $\{1,3,8,9,10\}$]{{\includegraphics[width = 0.4\linewidth]{Ex_Clusters1.pdf} }} \quad
      \subfloat[$\{2,4,5,6,7\}$]{{\includegraphics[width = 0.4\linewidth]{Ex_Clusters2.pdf} }}\\ 
      
         \subfloat[$\{11,16,19\}$]{{\includegraphics[width = 0.4\linewidth]{Ex_Clusters3.pdf} }} \quad
      \subfloat[$\{12,13,14,15,17,18,20\}$]{{\includegraphics[width = 0.45\linewidth]{Ex_Clusters4.pdf} }}\\
       
         \subfloat[$\{22,24,25,30\}$ ]{{\includegraphics[width = 0.4\linewidth]{Ex_Clusters5.pdf} }} \quad
      \subfloat[ $\{21,23,26,27,28,29\}$]{{\includegraphics[width = 0.45\linewidth]{Ex_Clusters6.pdf} }} \\
    \end{center}     
...
% Figure of functions, features and size for Martin_4.	
 \begin{figure}[t!]
   \hrulefill
   \begin{center} 
    \subfloat[]{{\includegraphics[width = 0.82\linewidth]{Martin4_fns.pdf} }} \\
      \subfloat[]{{\includegraphics[width = 0.82\linewidth]{Martin4_features.pdf} }} \\
      \subfloat[]{{\includegraphics[width = 0.82\linewidth]{Martin4_sizes.pdf} }}     
    \end{center}     
